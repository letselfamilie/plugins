...
module.exports = function(grunt) {
    var config = {
        ...
        browserify:     {
            ...
            chat_system: {
                src:        'chat/js/chat-system.js',
                dest:       'chat/js/compiled/chat-system.js'
            }
        }
    };
    ...
    var watchDebug = {
        ...
        scripts: {
            ...
            tasks: ['browserify:categories', 'browserify:topics', 'browserify:posts', 'browserify:chat', 'browserify:chat_system']
        }
    };
