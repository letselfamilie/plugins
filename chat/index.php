...
//        wp_enqueue_style( 'bootstrap', plugins_url('css/bootstrap.css', __FILE__), array(), date("h:i:s") );
//        wp_enqueue_script( 'bootstrap', plugins_url('js/bootstrap.min.js', __FILE__), array('jquery'), date("h:i:s"), true );
